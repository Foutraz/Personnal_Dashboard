@php
    $navItems = [
        ...
        ['label' => 'Sport', 'available' => false, 'icon' => 'M4 7h3l2-3h6l2 3h3M5 7v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7M9 13a3 3 0 1 0 6 0 3 3 0 0 0-6 0Z'],
        ['label' => 'Météo & Moto', 'available' => false, 'icon' => 'M3 15a4 4 0 0 0 4 4h9a4 4 0 0 0 0-8 6 6 0 0 0-11.7-1.8A4 4 0 0 0 3 15Z'],
        ['label' => 'Finance', 'available' => false, 'icon' => 'M3 17l5-5 4 4 8-8M21 8v5h-5'],
        ...
        ['label' => 'To-Do', 'available' => false, 'icon' => 'M9 11l3 3 8-8M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11'],
        ['label' => 'Objectifs', 'available' => false, 'icon' => 'M12 12a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm0 0a9 9 0 1 1 0 18 9 9 0 0 1 0-18Zm0 6v0M12 3v3'],
        ['label' => 'Cartes', 'available' => false, 'icon' => 'M9 6 3 4v14l6 2 6-2 6 2V6l-6-2-6 2Zm0 0v14m6-12v14'],
    ];
@endphp
