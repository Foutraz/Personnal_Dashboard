...
{
    /**
     * Create the spatie permission tables with ULID-compatible morph keys.
     */
    public function up(): void
    {
        ...
        throw_if(empty($tableNames), new RuntimeException('Permission configuration is not loaded.'));
        ...
        Schema::create($tableNames['model_has_permissions'], static function (Blueprint $table) use ($tableNames, $pivotPermission, $morphKey): void {
        ...
        Schema::create($tableNames['model_has_roles'], static function (Blueprint $table) use ($tableNames, $pivotRole, $morphKey): void {
    ...
    /**
     * Drop the spatie permission tables.
     */
