...
class Dashboard extends Component
{
    ...
    public function modules(): array
    {
        return [
            ...
            ['key' => 'planning', 'title' => 'Planning', 'description' => 'Agrégez Outlook et Google Calendar.', 'accent' => 'violet', 'available' => true, 'href' => route('planning'), 'icon' => 'M12 6v6l4 2M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
