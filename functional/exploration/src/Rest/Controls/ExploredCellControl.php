...
namespace Functional\Exploration\Rest\Controls;
...
class ExploredCellControl extends Control
{
    /**
     ...
     */
    protected string $model = ExploredCell::class;

    /**
     * Restrict access to the explored cells owned by the authenticated user.
     *
