...
- No comment in the code, only docstrings.
- No try-catch pattern.
- DocString should be written in English and make one sentence.
- Id's columns have to be ulid format.
- When "end" is sent by the user, delete the worktree you just created and close the session.
